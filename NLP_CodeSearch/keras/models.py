...
from keras.layers import Concatenate, Add,Dot, Embedding, Dropout, Lambda, Activation, LSTM, Dense,Reshape,Conv1D,MaxPooling1D,Flatten,GlobalMaxPooling1D,dot,Bidirectional,GlobalAveragePooling1D
...
class JointEmbeddingModel:
    ...
    def build(self):
        ...
        tokens_out = AttentionLayer()(tokens_dropout)
        
        #merge code#
        #code_out_1= Concatenate(name='code_merge',axis=1)([tokens_out,sbt_out])   #(122,200)
        #print(code_out_1)
        #code_out=Dense(self.model_params.get('n_embed_dims'), activation=None)(code_out_1)
        code_out = tokens_out
